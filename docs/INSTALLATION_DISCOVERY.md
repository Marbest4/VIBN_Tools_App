...
Der UI-Smoke erzeugt ein isoliertes Dateisystem-Fixture mit TIA Portal V20, Openness-DLL und TwinCAT sowie simulierte WinCC-/Siemens-Produkte. Er prüft Klassifizierung, dynamische V20-Auflösung und die WPF-Bindings. Die tatsächliche lokale Anzeige bleibt zusätzlich auf dem Zielrechner manuell abzunehmen.
