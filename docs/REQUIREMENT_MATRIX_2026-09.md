...
| Transfer als Hauptnavigation | offen | `MainWindow.xaml`, `ViCoWorkspacePage.xaml`, Bootstrapper | bestehende View/VM unverändert umhängen; gemeinsamer WorkspaceContext bleibt erhalten | Transfer-Smoke und Navigationstest |
| TIA als Hauptnavigation | offen | gleiche Bereiche, `TiaPortalPage*` | View umhängen, Bridge-Lebensdauer/Dispose erhalten | UI-Smoke, Bridge-Connect/Disconnect synthetisch und live |
| Administration als Hauptnavigation, nur Level 9 | teilweise; verschachtelt und ab Level 8 sichtbar | `MainWindowVM`, `ViCoWorkspacePageVM`, Rollen-Policy | eigenes Level-9-Gate; keine doppelte Rollenlogik | Core-Tests Level 0/7/8/9 und UI-Sichtbarkeit |
