...
| FEE2Container | erste provenancebasierte Version implementiert; aktuelles FEE-Mapping und Live-Abnahme offen | `FeeContainerProvenanceCodec`, `Fee2ContainerService`, `Fee2ContainerPageVM`/View, Visual Executor | BasicFrame-Root-Auswahl, persistente versionierte SDK-Tags, Auswahlprojektion, Prüfsumme, Vorschau und atomarer XML-Export; ältere/manuelle Modelle bewusst ausgeschlossen; aktuelle manuelle FEE-Variablen-/Slotänderungen noch nicht zurückprojiziert | automatischer Auswahl-/Prüfsummen-/PLC_IN-Snapshot-Round-Trip und WPF-Smoke; Entry→Variable/Slot-Reverse-Mapping sowie Persistenz nach echtem FEE-Save/Reload offen |
