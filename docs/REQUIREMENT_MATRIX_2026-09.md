...
| Grob Generation Interface verwenden | Identität und Plugin-Build geklärt; Executor offen | Discovery/Executor/FEE wrappers, unverändertes Pluginprojekt | Name, GUID und Provider gemeinsam prüfen; passende Signale wiederverwenden, fehlende dort erstellen; bei Widerspruch vorab abbrechen | Plugin- und Solution-Build 0/0; Fake-/Integrationstest; FEE-Live-Abnahme |
